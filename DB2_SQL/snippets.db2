...
<<<<<<< HEAD
-- Select library list for current user --
SELECT * FROM LIBRARY_LIST_INFO ;

=======
-- Alias for physical file member --
CREATE ALIAS QTEMP/MYALIAS FOR QTEMP/MYPF(MYMBR);
SELECT * FROM QTEMP/MYALIAS;
>>>>>>> 8b701af18a47910bbff684590286b020f33f951e
